...
public class IfitnessExceptionHandler extends ResponseEntityExceptionHandler{
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		String developerMessage = Optional.ofNullable(ex.getCause())
				.orElse(ex).toString();
	...
	public ResponseEntity<Object> handleNonExistentOrInactiveUserException(
			NonExistentOrInactiveUserException ex) {
		String userMessage = messageSource.getMessage(
				"user.non-existent-or-inactive", 
			null, LocaleContextHolder.getLocale());
